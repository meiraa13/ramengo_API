...
export class Initial1718131078111 implements MigrationInterface {
    name = 'Initial1718131078111'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "orders" ("id" SERIAL NOT NULL, "description" character varying NOT NULL, "image" character varying NOT NULL, "brothId" integer, "proteinId" integer, CONSTRAINT "PK_710e2d4957aa5878dfe94e4ac2f" PRIMARY KEY ("id"))`);
